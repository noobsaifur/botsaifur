...
if STRING_SESSION:
    ...
    bot = TelegramClient(StringSession(STRING_SESSION), "981717", "ee10aa2b825f3024060164b8b489610f")
else:
    # pylint: disable=invalid-name
    bot = TelegramClient("userbot", "981717" , "ee10aa2b825f3024060164b8b489610f")
